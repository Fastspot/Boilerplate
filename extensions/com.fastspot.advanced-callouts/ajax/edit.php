<?php
	...
	if (!$_POST["locked"] || $_POST["locked"] == "false") {
?>
<div id="callout_type">
	<fieldset>
...
?>
<input name="<?=$bigtree["callout_key"]?>[<?=$bigtree["callout_count"]?>][type]" type="hidden" value="<?=BigTree::safeEncode($bigtree["resources"]["type"])?>" />
<input name="<?=$bigtree["callout_key"]?>[<?=$bigtree["callout_count"]?>][!locked]" type="hidden" value="true" />
<?php		
	}
?>
